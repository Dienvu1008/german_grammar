                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: Text('12.5.8.5. Temporalsätze mit "seitdem"',
                  ...
                  children: <Widget>[
                    Padding(
                      padding: const EdgeInsets.only(
                          top: 10.0, left: 16.0, bottom: 10),
                      child: Text(
                          'Nominalisierung von temporalen Sätzen mit seitdem',
                          style: textTheme.titleSmall),
                    ),
                    Padding(
                        padding: const EdgeInsets.only(
...
''';
String htmlTable3_1 = '''
<table><colgroup> <col style="width: 37%;"> <col style="width: 11%;"> <col style="width: 10%;"> <col style="width: 25%;"> <col style="width: 10%;"> </colgroup>
<thead>
<tr>
<th>Hauptsatz 1</th>
<th>Hauptsatz 2\nPos. 1</th>
...
String htmlTable4 = '''
<table><colgroup> <col style="width: 39%;"> <col style="width: 39%;"> <col style="width: 22%;"> </colgroup>
<thead>
<tr>
<th>verbal\nKonjunktionen</th>
